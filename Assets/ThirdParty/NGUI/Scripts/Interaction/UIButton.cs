...
public class UIButton : UIButtonColor
{
	...
	public float clickSoundVolumn = 1.0f;
	...
	public override void SetState (State state, bool immediate)
	{
		...
		switch (state)
		{
		case State.Normal: PressScale (false); break;
		case State.Hover: PressScale (false); break;
		case State.Pressed: PressScale (true); break;
		case State.Disabled: PressScale (false); break;
		}
	}
